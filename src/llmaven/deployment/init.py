...
def initialize_config(
    ...
    print()
    print("   Option B: Create a .env file and use --env-file flag:")
    print("   Create .env.secrets with:")
    print("     LLMAVEN_SECRETS_LITELLM_MASTER_KEY=your-key-here")
    print("     LLMAVEN_SECRETS_AZURE_OPENAI_API_KEY=your-azure-openai-key")
