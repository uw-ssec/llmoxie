...
row. Useful for tools that work better with a flat table than nested JSON; try
re-running the analysis in `analysis.ipynb` against both formats to see which is
easier to work with.
